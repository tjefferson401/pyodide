...
typedef int(*cb_calcfc_in__cobyla__user__routines_typedef)(int *,int *,double *,double *,double *);
...
/* See f2py2e/rules.py */
extern int F_FUNC(cobyla ,COBYLA )(cb_calcfc_in__cobyla__user__routines_typedef,int*,int*,double*,double*,double*,int*,int*,double*,int*,double*);
/*eof externroutines*/
...
/*typedef int(*cb_calcfc_in__cobyla__user__routines_typedef)(int *,int *,double *,double *,double *);*/
static int cb_calcfc_in__cobyla__user__routines (int *n_cb_capi,int *m_cb_capi,double *x,double *f_cb_capi,double *con) {
...
static PyObject *f2py_rout__cobyla_minimize(const PyObject *capi_self,
                           ...
                           int (*f2py_func)(cb_calcfc_in__cobyla__user__routines_typedef,int*,int*,double*,double*,double*,int*,int*,double*,int*,double*)) {
...
PyMODINIT_FUNC PyInit__cobyla(void) {
  ...
  s = PyUnicode_FromString(
    "This module '_cobyla' is auto-generated with f2py (version:1.21.4).\nFunctions:\n"
