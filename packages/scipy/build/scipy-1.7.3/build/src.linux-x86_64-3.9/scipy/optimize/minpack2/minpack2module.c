...
/* See f2py2e/rules.py */
extern int F_FUNC(dcsrch,DCSRCH)(double*,double*,double*,double*,double*,double*,string,double*,double*,int*,double*,size_t);
extern int F_FUNC(dcstep,DCSTEP)(double*,double*,double*,double*,double*,double*,double*,double*,double*,int*,double*,double*);
/*eof externroutines*/
...
static PyObject *f2py_rout_minpack2_dcsrch(const PyObject *capi_self,
                           ...
                           int (*f2py_func)(double*,double*,double*,double*,double*,double*,string,double*,double*,int*,double*,size_t)) {
...
static PyObject *f2py_rout_minpack2_dcstep(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           int (*f2py_func)(double*,double*,double*,double*,double*,double*,double*,double*,double*,int*,double*,double*)) {
    PyObject * volatile capi_buildvalue = NULL;
    volatile int f2py_success = 1;
/*decl*/
...
PyMODINIT_FUNC PyInit_minpack2(void) {
  ...
  s = PyUnicode_FromString(
    "This module 'minpack2' is auto-generated with f2py (version:1.21.4).\nFunctions:\n"
"  stp,f,g,task = dcsrch(stp,f,g,ftol,gtol,xtol,task,stpmin,stpmax,isave,dsave)\n"
"  stx,fx,dx,sty,fy,dy,stp,brackt = dcstep(stx,fx,dx,sty,fy,dy,stp,fp,dp,brackt,stpmin,stpmax)\n"
".");
