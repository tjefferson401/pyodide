...
/* See f2py2e/rules.py */
extern int F_FUNC(slsqp,SLSQP)(int*,int*,int*,int*,double*,double*,double*,double*,double*,double*,double*,double*,int*,int*,double*,int*,int*,int*,double*,double*,double*,double*,double*,double*,double*,double*,double*,double*,int*,int*,int*,int*,int*,int*,int*,int*);
/*eof externroutines*/
...
static PyObject *f2py_rout__slsqp_slsqp(const PyObject *capi_self,
                           ...
                           int (*f2py_func)(int*,int*,int*,int*,double*,double*,double*,double*,double*,double*,double*,double*,int*,int*,double*,int*,int*,int*,double*,double*,double*,double*,double*,double*,double*,double*,double*,double*,int*,int*,int*,int*,int*,int*,int*,int*)) {
...
PyMODINIT_FUNC PyInit__slsqp(void) {
  ...
  s = PyUnicode_FromString(
    "This module '_slsqp' is auto-generated with f2py (version:1.21.4).\nFunctions:\n"
