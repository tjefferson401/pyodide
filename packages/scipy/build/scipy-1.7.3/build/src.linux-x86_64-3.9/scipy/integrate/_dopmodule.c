...
typedef int(*cb_solout_in___user__routines_typedef)(int *,double *,double *,double *,int *,double *,int *,int *,double *,int *,int *);
typedef int(*cb_fcn_in___user__routines_typedef)(int *,double *,double *,double *,double *,int *);
...
/* See f2py2e/rules.py */
extern int F_FUNC(dopri5,DOPRI5)(int*,cb_fcn_in___user__routines_typedef,double*,double*,double*,double*,double*,int*,cb_solout_in___user__routines_typedef,int*,double*,int*,int*,int*,double*,int*,int*);
extern int F_FUNC(dop853,DOP853)(int*,cb_fcn_in___user__routines_typedef,double*,double*,double*,double*,double*,int*,cb_solout_in___user__routines_typedef,int*,double*,int*,int*,int*,double*,int*,int*);
/*eof externroutines*/
...
/*typedef int(*cb_fcn_in___user__routines_typedef)(int *,double *,double *,double *,double *,int *);*/
static int cb_fcn_in___user__routines (int *n_cb_capi,double *x_cb_capi,double *y,double *f,double *rpar_cb_capi,int *ipar_cb_capi) {
...
/*typedef int(*cb_solout_in___user__routines_typedef)(int *,double *,double *,double *,int *,double *,int *,int *,double *,int *,int *);*/
static int cb_solout_in___user__routines (int *nr_cb_capi,double *xold_cb_capi,double *x_cb_capi,double *y,int *n_cb_capi,double *con,int *icomp,int *nd_cb_capi,double *rpar_cb_capi,int *ipar_cb_capi,int *irtn_cb_capi) {
...
static PyObject *f2py_rout__dop_dopri5(const PyObject *capi_self,
                           ...
                           int (*f2py_func)(int*,cb_fcn_in___user__routines_typedef,double*,double*,double*,double*,double*,int*,cb_solout_in___user__routines_typedef,int*,double*,int*,int*,int*,double*,int*,int*)) {
...
PyMODINIT_FUNC PyInit__dop(void) {
  ...
  s = PyUnicode_FromString(
    "This module '_dop' is auto-generated with f2py (version:1.21.4).\nFunctions:\n"
