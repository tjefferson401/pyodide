...
typedef int(*cb_jac_in_lsoda__user__routines_typedef)(int *,double *,double *,int *,int *,double *,int *);
typedef int(*cb_f_in_lsoda__user__routines_typedef)(int *,double *,double *,double *);
...
/*typedef int(*cb_f_in_lsoda__user__routines_typedef)(int *,double *,double *,double *);*/
static int cb_f_in_lsoda__user__routines (int *n_cb_capi,double *t_cb_capi,double *y,double *ydot) {
...
/*typedef int(*cb_jac_in_lsoda__user__routines_typedef)(int *,double *,double *,int *,int *,double *,int *);*/
static int cb_jac_in_lsoda__user__routines (int *n_cb_capi,double *t_cb_capi,double *y,int *ml_cb_capi,int *mu_cb_capi,double *jac,int *nrowpd_cb_capi) {
...
PyMODINIT_FUNC PyInit_lsoda(void) {
  ...
  s = PyUnicode_FromString(
    "This module 'lsoda' is auto-generated with f2py (version:1.21.4).\nFunctions:\n"
