...
/* See f2py2e/rules.py */
extern int F_FUNC(swilk,SWILK)(int*,float*,int*,int*,int*,float*,float*,float*,int*);
extern int F_FUNC(gscale,GSCALE)(int*,int*,float*,float*,int*,float*,float*,int*);
...
static PyObject *f2py_rout_statlib_swilk(const PyObject *capi_self,
                           ...
                           int (*f2py_func)(int*,float*,int*,int*,int*,float*,float*,float*,int*)) {
...
static PyObject *f2py_rout_statlib_gscale(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           int (*f2py_func)(int*,int*,float*,float*,int*,float*,float*,int*)) {
    PyObject * volatile capi_buildvalue = NULL;
    volatile int f2py_success = 1;
/*decl*/
...
PyMODINIT_FUNC PyInit_statlib(void) {
  ...
  s = PyUnicode_FromString(
    "This module 'statlib' is auto-generated with f2py (version:1.21.4).\nFunctions:\n"
