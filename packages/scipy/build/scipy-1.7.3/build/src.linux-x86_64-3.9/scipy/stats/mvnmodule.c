...
/* See f2py2e/rules.py */
extern int F_FUNC(mvndst,MVNDST)(int*,double*,double*,int*,double*,int*,double*,double*,double*,double*,int*);
/*eof externroutines*/
...
static PyObject *f2py_rout_mvn_mvndst(const PyObject *capi_self,
                           ...
                           int (*f2py_func)(int*,double*,double*,int*,double*,int*,double*,double*,double*,double*,int*)) {
...
static int f2py_setup_dkblck(char *ivls) {
  int i_f2py=0;
  f2py_dkblck_def[i_f2py++].data = ivls;
}
extern int F_FUNC(f2pyinitdkblck,F2PYINITDKBLCK)(int(*)(char*));
static int f2py_init_dkblck(void) {
...
PyMODINIT_FUNC PyInit_mvn(void) {
  ...
  s = PyUnicode_FromString(
    "This module 'mvn' is auto-generated with f2py (version:1.21.4).\nFunctions:\n"
