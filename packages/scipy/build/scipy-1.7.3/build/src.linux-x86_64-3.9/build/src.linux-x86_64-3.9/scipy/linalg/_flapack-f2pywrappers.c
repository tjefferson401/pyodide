...
/* Subroutine */ int f2pywrapslange_(real *slangef2pywrap, char *norm, integer *m, integer *n, real *a, integer *lda, real *work){
...
/* Subroutine */ int f2pywrapdlange_(doublereal *dlangef2pywrap, char *norm, integer *m, integer *n, doublereal *a, integer *lda, doublereal *work){
    /* System generated locals */
    integer a_dim1, a_offset;
...
/* Subroutine */ int f2pywrapclange_(real *clangef2pywrap, char *norm, integer *m, integer *n, complex *a, integer *lda, real *work){
    /* System generated locals */
    integer a_dim1, a_offset;
...
/* Subroutine */ int f2pywrapzlange_(doublereal *zlangef2pywrap, char *norm, integer *m, integer *n, doublecomplex *a, integer *lda, doublereal * work){
    /* System generated locals */
    integer a_dim1, a_offset;
