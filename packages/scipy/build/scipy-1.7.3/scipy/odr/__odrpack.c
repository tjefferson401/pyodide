...
int F_FUNC(dodrc,DODRC)(void (*fcn)(F_INT *n, F_INT *m, F_INT *np, F_INT *nq, F_INT *ldn, F_INT *ldm,
...
int F_FUNC(dwinf,DWINF)(F_INT *n, F_INT *m, F_INT *np, F_INT *nq, F_INT *ldwe, F_INT *ld2we, F_INT *isodr,
...
int F_FUNC(dluno,DLUNO)(F_INT *lun, char *fn, int fnlen);
int F_FUNC(dlunc,DLUNC)(F_INT *lun);
