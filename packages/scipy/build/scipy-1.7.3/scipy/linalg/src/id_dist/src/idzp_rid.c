...
/* Subroutine */ int idzp_rid__(integer *lproj, doublereal *eps, integer *m, integer *n, U_fp matveca, doublecomplex *p1, doublecomplex *p2, doublecomplex *p3, doublecomplex *p4, integer *krank, integer *list, doublecomplex *proj, integer *ier){
    /* System generated locals */
    integer i__1, i__2, i__3;

    /* Local variables */
    static integer k, lw, ira, lra;
    extern /* Subroutine */ int idz_findrank__(integer *, doublereal *, integer *, integer *, U_fp, doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *, integer *, doublecomplex *, integer *, doublecomplex *);    static integer iwork, lwork;
    extern /* Subroutine */ int idz_adjointer__(integer *, integer *, doublecomplex *, doublecomplex *);    static integer kranki;
    extern /* Subroutine */ int idzp_id__(doublereal *, integer *, integer *, doublecomplex *, integer *, integer *, doublecomplex *);
...
/* Subroutine */ int idz_findrank__(integer *lra, doublereal *eps, integer *m, integer *n, U_fp matveca, doublecomplex *p1, doublecomplex *p2, doublecomplex *p3, doublecomplex *p4, integer *krank, doublecomplex * ra, integer *ier, doublecomplex *w){
    /* System generated locals */
    integer ra_dim1, ra_offset;

    /* Local variables */
    static integer ix, iy, lw, lx, ly;
    extern /* Subroutine */ int idz_findrank0__(integer *, doublereal *, integer *, integer *, S_fp, doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *, integer *, doublecomplex *, integer *, doublecomplex *, doublecomplex *, doublecomplex *);    static integer iscal, lscal;
...
/* Subroutine */ int idz_findrank0__(integer *lra, doublereal *eps, integer * m, integer *n, S_fp matveca, doublecomplex *p1, doublecomplex *p2, doublecomplex *p3, doublecomplex *p4, integer *krank, doublecomplex * ra, integer *ier, doublecomplex *x, doublecomplex *y, doublecomplex * scal){
    /* System generated locals */
    ...
    static integer k, m2;
    extern /* Subroutine */ int idz_house__(integer *, doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *), idz_crunch__( integer *, integer *, doublecomplex *), idz_houseapp__(integer *, doublecomplex *, doublecomplex *, integer *, doublecomplex *, doublecomplex *);    static doublereal enorm;
...
/* Subroutine */ int idz_adjointer__(integer *m, integer *n, doublecomplex *a, doublecomplex *aa){
    /* System generated locals */
