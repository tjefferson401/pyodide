...
/* Subroutine */ int idzp_id__(doublereal *eps, integer *m, integer *n, doublecomplex *a, integer *krank, integer *list, doublereal *rnorms){
    /* System generated locals */
    integer a_dim1, a_offset, i__1, i__2, i__3;

    /* Local variables */
    static integer k;
    extern /* Subroutine */ int idzp_qrpiv__(doublereal *, integer *, integer *, doublecomplex *, integer *, integer *, doublereal *), idz_lssolve__(integer *, integer *, doublecomplex *, integer *);    static integer iswap;
...
/* Subroutine */ int idzr_id__(integer *m, integer *n, doublecomplex *a, integer *krank, integer *list, doublereal *rnorms){
    /* System generated locals */
    integer a_dim1, a_offset, i__1, i__2, i__3;
    doublereal d__1;
    ...
    extern /* Subroutine */ int idzr_qrpiv__(integer *, integer *, doublecomplex *, integer *, integer *, doublereal *), idz_lssolve__(integer *, integer *, doublecomplex *, integer *);    static integer iswap;
...
/* Subroutine */ int idz_reconid__(integer *m, integer *krank, doublecomplex * col, integer *n, integer *list, doublecomplex *proj, doublecomplex * approx){
    /* System generated locals */
...
/* Subroutine */ int idz_lssolve__(integer *m, integer *n, doublecomplex *a, integer *krank){
    /* System generated locals */
    ...
    extern /* Subroutine */ int idz_moverup__(integer *, integer *, integer *, doublecomplex *);    static doublereal rdenom, rnumer;
...
/* Subroutine */ int idz_moverup__(integer *m, integer *n, integer *krank, doublecomplex *a){
    /* System generated locals */
...
/* Subroutine */ int idz_getcols__(integer *m, integer *n, S_fp matvec, doublecomplex *p1, doublecomplex *p2, doublecomplex *p3, doublecomplex *p4, integer *krank, integer *list, doublecomplex *col, doublecomplex *x){
    /* System generated locals */
...
/* Subroutine */ int idz_reconint__(integer *n, integer *list, integer *krank, doublecomplex *proj, doublecomplex *p){
    /* System generated locals */
...
/* Subroutine */ int idz_copycols__(integer *m, integer *n, doublecomplex *a, integer *krank, integer *list, doublecomplex *col){
    /* System generated locals */
