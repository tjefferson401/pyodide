...
/* Subroutine */ int idzp_asvd__(integer *lw, doublereal *eps, integer *m, integer *n, doublecomplex *a, doublecomplex *winit, integer *krank, integer *iu, integer *iv, integer *is, doublecomplex *w, integer *ier){
    /* System generated locals */
    integer a_dim1, a_offset, i__1, i__2, i__3;

    /* Local variables */
    extern /* Subroutine */ int idzp_aid__(doublereal *, integer *, integer *, doublecomplex *, doublecomplex *, integer *, doublecomplex *, doublecomplex *);    static integer k;
    extern /* Subroutine */ int idzp_asvd0__(integer *, integer *, doublecomplex *, integer *, integer *, doublecomplex *, doublecomplex *, doublecomplex *, doublereal *, integer *, doublecomplex *, doublecomplex *);    static integer ls, lu, lv, lw2, isi, iui, ivi, icol, lcol, iproj, ilist, 
	    lproj, llist, iwork, lwork;
    extern /* Subroutine */ int idz_realcomplex__(integer *, doublereal *, doublecomplex *);
...
/* Subroutine */ int idzp_asvd0__(integer *m, integer *n, doublecomplex *a, integer *krank, integer *list, doublecomplex *proj, doublecomplex *u, doublecomplex *v, doublereal *s, integer *ier, doublecomplex *col, doublecomplex *work){
    /* System generated locals */
    integer a_dim1, a_offset, u_dim1, u_offset, v_dim1, v_offset, proj_dim1, 
	    proj_offset, col_dim1, col_offset, i__1;

    /* Local variables */
    extern /* Subroutine */ int idz_id2svd__(integer *, integer *, doublecomplex *, integer *, integer *, doublecomplex *, doublecomplex *, doublecomplex *, doublereal *, integer *, doublecomplex *), idz_copycols__(integer *, integer *, doublecomplex *, integer *, integer *, doublecomplex *);
