...
/* Subroutine */ int idd_permmult__(integer *m, integer *ind, integer *n, integer *indprod){
...
/* Subroutine */ int idd_qinqr__(integer *m, integer *n, doublereal *a, integer *krank, doublereal *q){
    /* System generated locals */
    ...
    extern /* Subroutine */ int idd_houseapp__(integer *, doublereal *, doublereal *, integer *, doublereal *, doublereal *);
...
/* Subroutine */ int idd_qmatvec__(integer *iftranspose, integer *m, integer * n, doublereal *a, integer *krank, doublereal *v){
    /* System generated locals */
...
/* Subroutine */ int idd_qmatmat__(integer *iftranspose, integer *m, integer * n, doublereal *a, integer *krank, integer *l, doublereal *b, doublereal *work){
    /* System generated locals */
...
/* Subroutine */ int iddp_qrpiv__(doublereal *eps, integer *m, integer *n, doublereal *a, integer *krank, integer *ind, doublereal *ss){
    /* System generated locals */
    ...
    extern /* Subroutine */ int idd_house__(integer *, doublereal *, doublereal *, doublereal *, doublereal *);    static integer mm;
    static doublereal scal, feps;
    static integer kpiv;
    extern /* Subroutine */ int idd_houseapp__(integer *, doublereal *, doublereal *, integer *, doublereal *, doublereal *);    static doublereal ssmax, rswap;
...
/* Subroutine */ int iddr_qrpiv__(integer *m, integer *n, doublereal *a, integer *krank, integer *ind, doublereal *ss){
    /* System generated locals */
