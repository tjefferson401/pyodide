...
/* Subroutine */ int idzr_aid__(integer *m, integer *n, doublecomplex *a, integer *krank, doublecomplex *w, integer *list, doublecomplex *proj){
    /* System generated locals */
    integer a_dim1, a_offset;

    /* Local variables */
    extern /* Subroutine */ int idzr_aid0__(integer *, integer *, doublecomplex *, integer *, doublecomplex *, integer *, doublecomplex *, doublecomplex *);    static integer ir, lr, iw, lw, lw2;
...
/* Subroutine */ int idzr_aid0__(integer *m, integer *n, doublecomplex *a, integer *krank, doublecomplex *w, integer *list, doublecomplex *proj, doublecomplex *r__){
    /* System generated locals */
    integer a_dim1, a_offset, r_dim1, r_offset, proj_dim1, proj_offset, i__1;

    /* Local variables */
    extern /* Subroutine */ int idz_sfrm__(integer *, integer *, integer *, doublecomplex *, doublecomplex *, doublecomplex *);    static integer k, l, n2, mn, lproj;
    extern /* Subroutine */ int idzr_copyzarr__(integer *, doublecomplex *, doublecomplex *), idzr_id__(integer *, integer *, doublecomplex *, integer *, integer *, doublecomplex *);
...
/* Subroutine */ int idzr_copyzarr__(integer *n, doublecomplex *a, doublecomplex *b){
    /* System generated locals */
...
/* Subroutine */ int idzr_aidi__(integer *m, integer *n, integer *krank, doublecomplex *w){
    static integer l, n2;
    extern /* Subroutine */ int idz_sfrmi__(integer *, integer *, integer *, doublecomplex *);
