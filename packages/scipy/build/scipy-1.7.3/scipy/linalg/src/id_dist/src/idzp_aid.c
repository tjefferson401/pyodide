...
/* Subroutine */ int idzp_aid__(doublereal *eps, integer *m, integer *n, doublecomplex *a, doublecomplex *work, integer *krank, integer *list, doublecomplex *proj){
    /* System generated locals */
    integer a_dim1, a_offset;

    /* Local variables */
    extern /* Subroutine */ int idzp_aid0__(doublereal *, integer *, integer *, doublecomplex *, integer *, integer *, doublecomplex *, doublereal *), idzp_aid1__(doublereal *, integer *, integer *, integer *, doublecomplex *, integer *, integer *, doublereal *) ;    static integer n2;
    extern /* Subroutine */ int idz_estrank__(doublereal *, integer *, integer *, doublecomplex *, doublecomplex *, integer *, doublecomplex *);    static integer kranki;
...
/* Subroutine */ int idzp_aid0__(doublereal *eps, integer *m, integer *n, doublecomplex *a, integer *krank, integer *list, doublecomplex *proj, doublereal *rnorms){
    /* System generated locals */
    integer a_dim1, a_offset, proj_dim1, proj_offset, i__1, i__2, i__3, i__4;

    /* Local variables */
    static integer j, k;
    extern /* Subroutine */ int idzp_id__(doublereal *, integer *, integer *, doublecomplex *, integer *, integer *, doublereal *);
...
/* Subroutine */ int idzp_aid1__(doublereal *eps, integer *n2, integer *n, integer *kranki, doublecomplex *proj, integer *krank, integer *list, doublereal *rnorms){
    /* System generated locals */
...
/* Subroutine */ int idz_estrank__(doublereal *eps, integer *m, integer *n, doublecomplex *a, doublecomplex *w, integer *krank, doublecomplex *ra){
    /* System generated locals */
    integer a_dim1, a_offset;

    /* Local variables */
    static integer n2, ira, lra, lra2;
    extern /* Subroutine */ int idz_estrank0__(doublereal *, integer *, integer *, doublecomplex *, doublecomplex *, integer *, integer *, doublecomplex *, doublecomplex *, doublereal *);    static integer irat, lrat, iscal, lscal;
...
/* Subroutine */ int idz_estrank0__(doublereal *eps, integer *m, integer *n, doublecomplex *a, doublecomplex *w, integer *n2, integer *krank, doublecomplex *ra, doublecomplex *rat, doublereal *scal){
    /* System generated locals */
    ...
    static integer j, k;
    extern /* Subroutine */ int idz_house__(integer *, doublecomplex *, doublecomplex *, doublecomplex *, doublereal *);    static doublereal ss;
    extern /* Subroutine */ int idz_houseapp__(integer *, doublecomplex *, doublecomplex *, integer *, doublereal *, doublecomplex *);    static doublereal ssmax;
    static integer nulls;
    extern /* Subroutine */ int idz_transposer__(integer *, integer *, doublecomplex *, doublecomplex *), idz_frm__(integer *, integer *, doublecomplex *, doublecomplex *, doublecomplex *);
...
/* Subroutine */ int idz_transposer__(integer *m, integer *n, doublecomplex * a, doublecomplex *at){
    /* System generated locals */
