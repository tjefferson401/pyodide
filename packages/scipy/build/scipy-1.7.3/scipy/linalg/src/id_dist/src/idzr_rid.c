...
/* Subroutine */ int idzr_rid__(integer *m, integer *n, U_fp matveca, doublecomplex *p1, doublecomplex *p2, doublecomplex *p3, doublecomplex *p4, integer *krank, integer *list, doublecomplex *proj){
    static integer ir, lr, ix, iy, lw, lx, ly;
    extern /* Subroutine */ int idzr_ridall0__(integer *, integer *, S_fp, doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *, integer *, integer *, doublecomplex *, doublecomplex *, doublecomplex *);
...
/* Subroutine */ int idzr_ridall0__(integer *m, integer *n, S_fp matveca, doublecomplex *p1, doublecomplex *p2, doublecomplex *p3, doublecomplex *p4, integer *krank, integer *list, doublecomplex *r__, doublecomplex *x, doublecomplex *y){
    ...
    extern /* Subroutine */ int idzr_id__(integer *, integer *, doublecomplex *, integer *, integer *, doublecomplex *);
