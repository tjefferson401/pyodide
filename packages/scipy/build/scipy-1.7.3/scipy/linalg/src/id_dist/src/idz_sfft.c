...
/* Subroutine */ int idz_sffti__(integer *l, integer *ind, integer *n, doublecomplex *wsave){
...
/* Subroutine */ int idz_sfft__(integer *l, integer *ind, integer *n, doublecomplex *wsave, doublecomplex *v){
    /* System generated locals */
    ...
    extern /* Subroutine */ int zfftf_(integer *, doublecomplex *, doublecomplex *);    static doublereal twopi;
    static integer nblock;
