...
/* Subroutine */ int idd_houseapp__(integer *n, doublereal *vn, doublereal *u, integer *ifrescal, doublereal *scal, doublereal *v){
...
/* Subroutine */ int idd_house__(integer *n, doublereal *x, doublereal *rss, doublereal *vn, doublereal *scal){
    /* System generated locals */
    integer i__1;
...
/* Subroutine */ int idd_housemat__(integer *n, doublereal *vn, doublereal * scal, doublereal *h__){
    /* System generated locals */
