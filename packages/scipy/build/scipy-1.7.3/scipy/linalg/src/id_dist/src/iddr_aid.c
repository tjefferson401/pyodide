...
/* Subroutine */ int iddr_aid__(integer *m, integer *n, doublereal *a, integer *krank, doublereal *w, integer *list, doublereal *proj){
    /* System generated locals */
    integer a_dim1, a_offset;

    /* Local variables */
    extern /* Subroutine */ int iddr_aid0__(integer *, integer *, doublereal * , integer *, doublereal *, integer *, doublereal *, doublereal *);    static integer ir, lr, iw, lw, lw2;
...
/* Subroutine */ int iddr_aid0__(integer *m, integer *n, doublereal *a, integer *krank, doublereal *w, integer *list, doublereal *proj, doublereal *r__){
    /* System generated locals */
    integer a_dim1, a_offset, r_dim1, r_offset, proj_dim1, proj_offset, i__1;

    /* Local variables */
    extern /* Subroutine */ int idd_sfrm__(integer *, integer *, integer *, doublereal *, doublereal *, doublereal *);    static integer k, l, n2, mn, lproj;
    extern /* Subroutine */ int iddr_copydarr__(integer *, doublereal *, doublereal *), iddr_id__(integer *, integer *, doublereal *, integer *, integer *, doublereal *);
...
/* Subroutine */ int iddr_aidi__(integer *m, integer *n, integer *krank, doublereal *w){
    static integer l;
    extern /* Subroutine */ int idd_sfrmi__(integer *, integer *, integer *, doublereal *);    static integer n2;
