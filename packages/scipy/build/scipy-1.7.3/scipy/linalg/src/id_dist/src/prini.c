...
/* Subroutine */ int prini_0_(int n__, integer *ip1, integer *iq1, char *mes, real *a, integer *n, doublereal *a2, doublereal *a4, integer *ia, shortint *ia2, char *aa, ftnlen mes_len, ftnlen aa_len){
    /* Format strings */
...
/* Subroutine */ int prin2_(char *mes, doublereal *a2, integer *n, ftnlen mes_len){
    return prini_0_(2, (integer *)0, (integer *)0, mes, (real *)0, n, a2, (
	    doublereal *)0, (integer *)0, (shortint *)0, (char *)0, mes_len, (
	    ftnint)0);
    }

/* Subroutine */ int prin2_long__(char *mes, doublereal *a2, integer *n, ftnlen mes_len){
    return prini_0_(3, (integer *)0, (integer *)0, mes, (real *)0, n, a2, (
	    doublereal *)0, (integer *)0, (shortint *)0, (char *)0, mes_len, (
	    ftnint)0);
    }

/* Subroutine */ int prinq_(char *mes, doublereal *a4, integer *n, ftnlen mes_len){
    return prini_0_(4, (integer *)0, (integer *)0, mes, (real *)0, n, (
	    doublereal *)0, a4, (integer *)0, (shortint *)0, (char *)0, 
	    mes_len, (ftnint)0);
    }

/* Subroutine */ int prinf_(char *mes, integer *ia, integer *n, ftnlen mes_len){
    return prini_0_(5, (integer *)0, (integer *)0, mes, (real *)0, n, (
	    doublereal *)0, (doublereal *)0, ia, (shortint *)0, (char *)0, 
	    mes_len, (ftnint)0);
    }

/* Subroutine */ int prinf2_(char *mes, shortint *ia2, integer *n, ftnlen mes_len){
    return prini_0_(6, (integer *)0, (integer *)0, mes, (real *)0, n, (
	    doublereal *)0, (doublereal *)0, (integer *)0, ia2, (char *)0, 
	    mes_len, (ftnint)0);
    }

/* Subroutine */ int prina_(char *mes, char *aa, integer *n, ftnlen mes_len, ftnlen aa_len){
...
/* Subroutine */ int messpr_(char *mes, integer *ip, integer *iq, ftnlen mes_len){
    /* Initialized data */
...
/* Subroutine */ int msgmerge_(char *a, char *b, char *c__, ftnlen a_len, ftnlen b_len, ftnlen c_len){
    /* Initialized data */
...
/* Subroutine */ int mach_zero__(doublereal *zero_mach__)
{
    static doublereal d__;
    static integer i__;
    static doublereal d1, d3, d2, d4;
    extern /* Subroutine */ int mach_zero0__(doublereal *, doublereal *, doublereal *);
...
/* Subroutine */ int mach_zero0__(doublereal *a, doublereal *b, doublereal * c__){
