...
/* Subroutine */ int idz_houseapp__(integer *n, doublecomplex *vn, doublecomplex *u, integer *ifrescal, doublereal *scal, doublecomplex * v){
...
/* Subroutine */ int idz_house__(integer *n, doublecomplex *x, doublecomplex * css, doublecomplex *vn, doublereal *scal){
    /* System generated locals */
    integer i__1, i__2;
    doublereal d__1;
...
/* Subroutine */ int idz_housemat__(integer *n, doublecomplex *vn, doublereal *scal, doublecomplex *h__){
    /* System generated locals */
