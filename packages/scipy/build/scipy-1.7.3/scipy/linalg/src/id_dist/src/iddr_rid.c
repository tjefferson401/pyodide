...
/* Subroutine */ int iddr_rid__(integer *m, integer *n, U_fp matvect, doublereal *p1, doublereal *p2, doublereal *p3, doublereal *p4, integer *krank, integer *list, doublereal *proj){
    static integer ir, lr, ix, iy, lw, lx, ly;
    extern /* Subroutine */ int iddr_ridall0__(integer *, integer *, S_fp, doublereal *, doublereal *, doublereal *, doublereal *, integer *, integer *, doublereal *, doublereal *, doublereal *);
...
/* Subroutine */ int iddr_ridall0__(integer *m, integer *n, S_fp matvect, doublereal *p1, doublereal *p2, doublereal *p3, doublereal *p4, integer *krank, integer *list, doublereal *r__, doublereal *x, doublereal *y){
    ...
    extern /* Subroutine */ int iddr_id__(integer *, integer *, doublereal *, integer *, integer *, doublereal *);
