...
/* Subroutine */ int idd_snorm__(integer *m, integer *n, S_fp matvect, doublereal *p1t, doublereal *p2t, doublereal *p3t, doublereal *p4t, S_fp matvec, doublereal *p1, doublereal *p2, doublereal *p3, doublereal *p4, integer *its, doublereal *snorm, doublereal *v, doublereal *u){
    ...
    static integer k;
    extern /* Subroutine */ int idd_enorm__(integer *, doublereal *, doublereal *);    static integer it;
...
/* Subroutine */ int idd_diffsnorm__(integer *m, integer *n, U_fp matvect, doublereal *p1t, doublereal *p2t, doublereal *p3t, doublereal *p4t, U_fp matvect2, doublereal *p1t2, doublereal *p2t2, doublereal *p3t2, doublereal *p4t2, U_fp matvec, doublereal *p1, doublereal *p2, doublereal *p3, doublereal *p4, U_fp matvec2, doublereal *p12, doublereal *p22, doublereal *p32, doublereal *p42, integer *its, doublereal *snorm, doublereal *w){
    static integer iu, iv, lu, lv, lw, iu1, iu2, iv1, lu1, lu2, lv1, iv2, lv2;
    extern /* Subroutine */ int idd_diffsnorm0__(integer *, integer *, S_fp, doublereal *, doublereal *, doublereal *, doublereal *, S_fp, doublereal *, doublereal *, doublereal *, doublereal *, S_fp, doublereal *, doublereal *, doublereal *, doublereal *, S_fp, doublereal *, doublereal *, doublereal *, doublereal *, integer *, doublereal *, doublereal *, doublereal *, doublereal *, doublereal *, doublereal *, doublereal *);
...
/* Subroutine */ int idd_diffsnorm0__(integer *m, integer *n, S_fp matvect, doublereal *p1t, doublereal *p2t, doublereal *p3t, doublereal *p4t, S_fp matvect2, doublereal *p1t2, doublereal *p2t2, doublereal *p3t2, doublereal *p4t2, S_fp matvec, doublereal *p1, doublereal *p2, doublereal *p3, doublereal *p4, S_fp matvec2, doublereal *p12, doublereal *p22, doublereal *p32, doublereal *p42, integer *its, doublereal *snorm, doublereal *u, doublereal *u1, doublereal *u2, doublereal *v, doublereal *v1, doublereal *v2){
    /* System generated locals */
    integer i__1, i__2;
