...
/* Subroutine */ int idz_snorm__(integer *m, integer *n, S_fp matveca, doublecomplex *p1a, doublecomplex *p2a, doublecomplex *p3a, doublecomplex *p4a, S_fp matvec, doublecomplex *p1, doublecomplex *p2, doublecomplex *p3, doublecomplex *p4, integer *its, doublereal * snorm, doublecomplex *v, doublecomplex *u){
    ...
    static integer k, n2;
    extern /* Subroutine */ int idz_enorm__(integer *, doublecomplex *, doublereal *);    static integer it;
...
/* Subroutine */ int idz_enorm__(integer *n, doublecomplex *v, doublereal * enorm){
    /* System generated locals */
    integer i__1, i__2;
...
/* Subroutine */ int idz_diffsnorm__(integer *m, integer *n, U_fp matveca, doublecomplex *p1a, doublecomplex *p2a, doublecomplex *p3a, doublecomplex *p4a, U_fp matveca2, doublecomplex *p1a2, doublecomplex *p2a2, doublecomplex *p3a2, doublecomplex *p4a2, U_fp matvec, doublecomplex *p1, doublecomplex *p2, doublecomplex *p3, doublecomplex *p4, U_fp matvec2, doublecomplex *p12, doublecomplex * p22, doublecomplex *p32, doublecomplex *p42, integer *its, doublereal *snorm, doublecomplex *w){
    static integer iu, iv, lu, lv, lw, iu1, iu2, iv1, lu1, lu2, lv1, iv2, lv2;
    extern /* Subroutine */ int idz_diffsnorm0__(integer *, integer *, S_fp, doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *, S_fp, doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *, S_fp, doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *, S_fp, doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *, integer *, doublereal *, doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *, doublecomplex *);
...
/* Subroutine */ int idz_diffsnorm0__(integer *m, integer *n, S_fp matveca, doublecomplex *p1a, doublecomplex *p2a, doublecomplex *p3a, doublecomplex *p4a, S_fp matveca2, doublecomplex *p1a2, doublecomplex *p2a2, doublecomplex *p3a2, doublecomplex *p4a2, S_fp matvec, doublecomplex *p1, doublecomplex *p2, doublecomplex *p3, doublecomplex *p4, S_fp matvec2, doublecomplex *p12, doublecomplex * p22, doublecomplex *p32, doublecomplex *p42, integer *its, doublereal *snorm, doublecomplex *u, doublecomplex *u1, doublecomplex *u2, doublecomplex *v, doublecomplex *v1, doublecomplex *v2){
    /* System generated locals */
