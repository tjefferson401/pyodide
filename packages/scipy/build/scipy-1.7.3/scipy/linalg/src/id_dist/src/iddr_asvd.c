...
/* Subroutine */ int iddr_asvd__(integer *m, integer *n, doublereal *a, integer *krank, doublereal *w, doublereal *u, doublereal *v, doublereal *s, integer *ier){
    /* System generated locals */
    integer a_dim1, a_offset, u_dim1, u_offset, v_dim1, v_offset, i__1;

    /* Local variables */
    extern /* Subroutine */ int iddr_asvd0__(integer *, integer *, doublereal *, integer *, doublereal *, doublereal *, doublereal *, doublereal *, integer *, integer *, doublereal *, doublereal *, doublereal *);    static integer lw, icol, lcol, iproj, ilist, lproj, llist, iwork, lwork, 
	    iwinit, lwinit;
...
/* Subroutine */ int iddr_asvd0__(integer *m, integer *n, doublereal *a, integer *krank, doublereal *winit, doublereal *u, doublereal *v, doublereal *s, integer *ier, integer *list, doublereal *proj, doublereal *col, doublereal *work){
    /* System generated locals */
    integer a_dim1, a_offset, u_dim1, u_offset, v_dim1, v_offset, proj_dim1, 
	    proj_offset, i__1;

    /* Local variables */
    extern /* Subroutine */ int iddr_aid__(integer *, integer *, doublereal *, integer *, doublereal *, integer *, doublereal *), idd_id2svd__( integer *, integer *, doublereal *, integer *, integer *, doublereal *, doublereal *, doublereal *, doublereal *, integer *, doublereal *), idd_copycols__(integer *, integer *, doublereal *, integer *, integer *, doublereal *);
