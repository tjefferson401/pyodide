...
/* Subroutine */ int iddp_aid__(doublereal *eps, integer *m, integer *n, doublereal *a, doublereal *work, integer *krank, integer *list, doublereal *proj){
    /* System generated locals */
    integer a_dim1, a_offset;

    /* Local variables */
    extern /* Subroutine */ int iddp_aid0__(doublereal *, integer *, integer * , doublereal *, integer *, integer *, doublereal *, doublereal *), iddp_aid1__(doublereal *, integer *, integer *, integer *, doublereal *, integer *, integer *, doublereal *);    static integer n2;
    extern /* Subroutine */ int idd_estrank__(doublereal *, integer *, integer *, doublereal *, doublereal *, integer *, doublereal *);    static integer kranki;
...
/* Subroutine */ int iddp_aid0__(doublereal *eps, integer *m, integer *n, doublereal *a, integer *krank, integer *list, doublereal *proj, doublereal *rnorms){
    /* System generated locals */
    integer a_dim1, a_offset, proj_dim1, proj_offset, i__1, i__2;

    /* Local variables */
    static integer j, k;
    extern /* Subroutine */ int iddp_id__(doublereal *, integer *, integer *, doublereal *, integer *, integer *, doublereal *);
...
/* Subroutine */ int iddp_aid1__(doublereal *eps, integer *n2, integer *n, integer *kranki, doublereal *proj, integer *krank, integer *list, doublereal *rnorms){
    /* System generated locals */
    integer i__1, i__2;
...
/* Subroutine */ int idd_estrank__(doublereal *eps, integer *m, integer *n, doublereal *a, doublereal *w, integer *krank, doublereal *ra){
    /* System generated locals */
    integer a_dim1, a_offset;

    /* Local variables */
    static integer n2, ira, lra, lra2;
    extern /* Subroutine */ int idd_estrank0__(doublereal *, integer *, integer *, doublereal *, doublereal *, integer *, integer *, doublereal *, doublereal *, doublereal *);    static integer irat, lrat, iscal, lscal;
...
/* Subroutine */ int idd_estrank0__(doublereal *eps, integer *m, integer *n, doublereal *a, doublereal *w, integer *n2, integer *krank, doublereal *ra, doublereal *rat, doublereal *scal){
    /* System generated locals */
    ...
    static integer j, k;
    extern /* Subroutine */ int idd_house__(integer *, doublereal *, doublereal *, doublereal *, doublereal *);    static doublereal ss;
    extern /* Subroutine */ int idd_houseapp__(integer *, doublereal *, doublereal *, integer *, doublereal *, doublereal *);    static doublereal ssmax;
    static integer nulls;
    extern /* Subroutine */ int idd_frm__(integer *, integer *, doublereal *, doublereal *, doublereal *), idd_atransposer__(integer *, integer *, doublereal *, doublereal *);
...
/* Subroutine */ int idd_atransposer__(integer *m, integer *n, doublereal *a, doublereal *at){
    /* System generated locals */
