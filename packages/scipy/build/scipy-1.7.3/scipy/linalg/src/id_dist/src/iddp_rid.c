...
/* Subroutine */ int iddp_rid__(integer *lproj, doublereal *eps, integer *m, integer *n, U_fp matvect, doublereal *p1, doublereal *p2, doublereal * p3, doublereal *p4, integer *krank, integer *list, doublereal *proj, integer *ier){
    /* System generated locals */
    integer i__1;

    /* Local variables */
    extern /* Subroutine */ int idd_rtransposer__(integer *, integer *, doublereal *, doublereal *);    static integer k, lw, ira, lra;
    extern /* Subroutine */ int idd_findrank__(integer *, doublereal *, integer *, integer *, U_fp, doublereal *, doublereal *, doublereal *, doublereal *, integer *, doublereal *, integer *, doublereal *);    static integer iwork, lwork, kranki;
...
/* Subroutine */ int idd_findrank__(integer *lra, doublereal *eps, integer *m, integer *n, U_fp matvect, doublereal *p1, doublereal *p2, doublereal *p3, doublereal *p4, integer *krank, doublereal *ra, integer *ier, doublereal *w){
    /* System generated locals */
    integer ra_dim1, ra_offset;

    /* Local variables */
    static integer ix, iy, lw, lx, ly;
    extern /* Subroutine */ int idd_findrank0__(integer *, doublereal *, integer *, integer *, S_fp, doublereal *, doublereal *, doublereal *, doublereal *, integer *, doublereal *, integer *, doublereal *, doublereal *, doublereal *);    static integer iscal, lscal;
...
/* Subroutine */ int idd_findrank0__(integer *lra, doublereal *eps, integer * m, integer *n, S_fp matvect, doublereal *p1, doublereal *p2, doublereal *p3, doublereal *p4, integer *krank, doublereal *ra, integer *ier, doublereal *x, doublereal *y, doublereal *scal){
    /* System generated locals */
    ...
    static integer k;
    extern /* Subroutine */ int idd_house__(integer *, doublereal *, doublereal *, doublereal *, doublereal *), idd_crunch__(integer *, integer *, doublereal *), idd_houseapp__(integer *, doublereal *, doublereal *, integer *, doublereal *, doublereal *);    static doublereal enorm;
...
/* Subroutine */ int idd_rtransposer__(integer *m, integer *n, doublereal *a, doublereal *at){
    /* System generated locals */
