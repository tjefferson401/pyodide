...
/* Subroutine */ int iddp_id__(doublereal *eps, integer *m, integer *n, doublereal *a, integer *krank, integer *list, doublereal *rnorms){
    /* System generated locals */
    integer a_dim1, a_offset, i__1;

    /* Local variables */
    static integer k;
    extern /* Subroutine */ int iddp_qrpiv__(doublereal *, integer *, integer *, doublereal *, integer *, integer *, doublereal *), idd_lssolve__(integer *, integer *, doublereal *, integer *);    static integer iswap;
...
/* Subroutine */ int iddr_id__(integer *m, integer *n, doublereal *a, integer *krank, integer *list, doublereal *rnorms){
    /* System generated locals */
    ...
    extern /* Subroutine */ int iddr_qrpiv__(integer *, integer *, doublereal *, integer *, integer *, doublereal *), idd_lssolve__(integer *, integer *, doublereal *, integer *);    static integer iswap;
...
/* Subroutine */ int idd_reconid__(integer *m, integer *krank, doublereal * col, integer *n, integer *list, doublereal *proj, doublereal *approx){
    /* System generated locals */
...
/* Subroutine */ int idd_lssolve__(integer *m, integer *n, doublereal *a, integer *krank){
    /* System generated locals */
    integer a_dim1, a_offset, i__1, i__2;
    ...
    extern /* Subroutine */ int idd_moverup__(integer *, integer *, integer *, doublereal *);
...
/* Subroutine */ int idd_moverup__(integer *m, integer *n, integer *krank, doublereal *a){
    /* System generated locals */
    integer i__1, i__2;
...
/* Subroutine */ int idd_getcols__(integer *m, integer *n, S_fp matvec, doublereal *p1, doublereal *p2, doublereal *p3, doublereal *p4, integer *krank, integer *list, doublereal *col, doublereal *x){
    /* System generated locals */
...
/* Subroutine */ int idd_reconint__(integer *n, integer *list, integer *krank, doublereal *proj, doublereal *p){
    /* System generated locals */
...
/* Subroutine */ int idd_copycols__(integer *m, integer *n, doublereal *a, integer *krank, integer *list, doublereal *col){
    /* System generated locals */
