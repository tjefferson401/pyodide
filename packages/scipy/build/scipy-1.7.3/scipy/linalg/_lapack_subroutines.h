...
int F_FUNC(chla_transtypewrp, CHLA_TRANSTYPEWRP)(char *ret, int *trans);
...
int F_FUNC(clanhfwrp, CLANHFWRP)(float *ret, char *norm, char *transr, char *uplo, int *n, npy_complex64 *a, float *work);
...
int F_FUNC(dlansfwrp, DLANSFWRP)(double *ret, char *norm, char *transr, char *uplo, int *n, double *a, double *work);
...
int F_FUNC(ilaclcwrp, ILACLCWRP)(int *ret, int *m, int *n, npy_complex64 *a, int *lda);
int F_FUNC(ilaclrwrp, ILACLRWRP)(int *ret, int *m, int *n, npy_complex64 *a, int *lda);
int F_FUNC(iladiagwrp, ILADIAGWRP)(int *ret, char *diag);
int F_FUNC(iladlcwrp, ILADLCWRP)(int *ret, int *m, int *n, double *a, int *lda);
int F_FUNC(iladlrwrp, ILADLRWRP)(int *ret, int *m, int *n, double *a, int *lda);
int F_FUNC(ilaprecwrp, ILAPRECWRP)(int *ret, char *prec);
int F_FUNC(ilaslcwrp, ILASLCWRP)(int *ret, int *m, int *n, float *a, int *lda);
int F_FUNC(ilaslrwrp, ILASLRWRP)(int *ret, int *m, int *n, float *a, int *lda);
int F_FUNC(ilatranswrp, ILATRANSWRP)(int *ret, char *trans);
int F_FUNC(ilauplowrp, ILAUPLOWRP)(int *ret, char *uplo);
int F_FUNC(ilazlcwrp, ILAZLCWRP)(int *ret, int *m, int *n, npy_complex128 *a, int *lda);
int F_FUNC(ilazlrwrp, ILAZLRWRP)(int *ret, int *m, int *n, npy_complex128 *a, int *lda);
...
int F_FUNC(slansfwrp, SLANSFWRP)(float *ret, char *norm, char *transr, char *uplo, int *n, float *a, float *work);
...
int F_FUNC(zlanhfwrp, ZLANHFWRP)(double *ret, char *norm, char *transr, char *uplo, int *n, npy_complex128 *a, double *work);
...
int F_FUNC(cbbcsd,CBBCSD)(char *jobu1, char *jobu2, char *jobv1t, char *jobv2t, char *trans, int *m, int *p, int *q, float *theta, float *phi, npy_complex64 *u1, int *ldu1, npy_complex64 *u2, int *ldu2, npy_complex64 *v1t, int *ldv1t, npy_complex64 *v2t, int *ldv2t, float *b11d, float *b11e, float *b12d, float *b12e, float *b21d, float *b21e, float *b22d, float *b22e, float *rwork, int *lrwork, int *info);
...
int F_FUNC(cgbequb,CGBEQUB)(int *m, int *n, int *kl, int *ku, npy_complex64 *ab, int *ldab, float *r, float *c, float *rowcnd, float *colcnd, float *amax, int *info);
...
int F_FUNC(cgeequb,CGEEQUB)(int *m, int *n, npy_complex64 *a, int *lda, float *r, float *c, float *rowcnd, float *colcnd, float *amax, int *info);
...
int F_FUNC(cgemqrt,CGEMQRT)(char *side, char *trans, int *m, int *n, int *k, int *nb, npy_complex64 *v, int *ldv, npy_complex64 *t, int *ldt, npy_complex64 *c, int *ldc, npy_complex64 *work, int *info);
...
int F_FUNC(cgeqr2p,CGEQR2P)(int *m, int *n, npy_complex64 *a, int *lda, npy_complex64 *tau, npy_complex64 *work, int *info);
int F_FUNC(cgeqrf,CGEQRF)(int *m, int *n, npy_complex64 *a, int *lda, npy_complex64 *tau, npy_complex64 *work, int *lwork, int *info);
int F_FUNC(cgeqrfp,CGEQRFP)(int *m, int *n, npy_complex64 *a, int *lda, npy_complex64 *tau, npy_complex64 *work, int *lwork, int *info);
int F_FUNC(cgeqrt,CGEQRT)(int *m, int *n, int *nb, npy_complex64 *a, int *lda, npy_complex64 *t, int *ldt, npy_complex64 *work, int *info);
int F_FUNC(cgeqrt2,CGEQRT2)(int *m, int *n, npy_complex64 *a, int *lda, npy_complex64 *t, int *ldt, int *info);
int F_FUNC(cgeqrt3,CGEQRT3)(int *m, int *n, npy_complex64 *a, int *lda, npy_complex64 *t, int *ldt, int *info);
...
int F_FUNC(cheequb,CHEEQUB)(char *uplo, int *n, npy_complex64 *a, int *lda, float *s, float *scond, float *amax, npy_complex64 *work, int *info);
...
int F_FUNC(cheswapr,CHESWAPR)(char *uplo, int *n, npy_complex64 *a, int *lda, int *i1, int *i2);
...
int F_FUNC(chetri2,CHETRI2)(char *uplo, int *n, npy_complex64 *a, int *lda, int *ipiv, npy_complex64 *work, int *lwork, int *info);
int F_FUNC(chetri2x,CHETRI2X)(char *uplo, int *n, npy_complex64 *a, int *lda, int *ipiv, npy_complex64 *work, int *nb, int *info);
int F_FUNC(chetrs,CHETRS)(char *uplo, int *n, int *nrhs, npy_complex64 *a, int *lda, int *ipiv, npy_complex64 *b, int *ldb, int *info);
int F_FUNC(chetrs2,CHETRS2)(char *uplo, int *n, int *nrhs, npy_complex64 *a, int *lda, int *ipiv, npy_complex64 *b, int *ldb, npy_complex64 *work, int *info);
int F_FUNC(chfrk,CHFRK)(char *transr, char *uplo, char *trans, int *n, int *k, float *alpha, npy_complex64 *a, int *lda, float *beta, npy_complex64 *c);
...
int F_FUNC(clapmr,CLAPMR)(int *forwrd, int *m, int *n, npy_complex64 *x, int *ldx, int *k);
...
int F_FUNC(clarfgp,CLARFGP)(int *n, npy_complex64 *alpha, npy_complex64 *x, int *incx, npy_complex64 *tau);
...
int F_FUNC(cpftrf,CPFTRF)(char *transr, char *uplo, int *n, npy_complex64 *a, int *info);
int F_FUNC(cpftri,CPFTRI)(char *transr, char *uplo, int *n, npy_complex64 *a, int *info);
int F_FUNC(cpftrs,CPFTRS)(char *transr, char *uplo, int *n, int *nrhs, npy_complex64 *a, npy_complex64 *b, int *ldb, int *info);
...
int F_FUNC(cpoequb,CPOEQUB)(int *n, npy_complex64 *a, int *lda, float *s, float *scond, float *amax, int *info);
...
int F_FUNC(cpstf2,CPSTF2)(char *uplo, int *n, npy_complex64 *a, int *lda, int *piv, int *rank, float *tol, float *work, int *info);
int F_FUNC(cpstrf,CPSTRF)(char *uplo, int *n, npy_complex64 *a, int *lda, int *piv, int *rank, float *tol, float *work, int *info);
...
int F_FUNC(csyconv,CSYCONV)(char *uplo, char *way, int *n, npy_complex64 *a, int *lda, int *ipiv, npy_complex64 *work, int *info);
int F_FUNC(csyequb,CSYEQUB)(char *uplo, int *n, npy_complex64 *a, int *lda, float *s, float *scond, float *amax, npy_complex64 *work, int *info);
...
int F_FUNC(csyswapr,CSYSWAPR)(char *uplo, int *n, npy_complex64 *a, int *lda, int *i1, int *i2);
...
int F_FUNC(csytri2,CSYTRI2)(char *uplo, int *n, npy_complex64 *a, int *lda, int *ipiv, npy_complex64 *work, int *lwork, int *info);
int F_FUNC(csytri2x,CSYTRI2X)(char *uplo, int *n, npy_complex64 *a, int *lda, int *ipiv, npy_complex64 *work, int *nb, int *info);
int F_FUNC(csytrs,CSYTRS)(char *uplo, int *n, int *nrhs, npy_complex64 *a, int *lda, int *ipiv, npy_complex64 *b, int *ldb, int *info);
int F_FUNC(csytrs2,CSYTRS2)(char *uplo, int *n, int *nrhs, npy_complex64 *a, int *lda, int *ipiv, npy_complex64 *b, int *ldb, npy_complex64 *work, int *info);
...
int F_FUNC(ctfsm,CTFSM)(char *transr, char *side, char *uplo, char *trans, char *diag, int *m, int *n, npy_complex64 *alpha, npy_complex64 *a, npy_complex64 *b, int *ldb);
int F_FUNC(ctftri,CTFTRI)(char *transr, char *uplo, char *diag, int *n, npy_complex64 *a, int *info);
int F_FUNC(ctfttp,CTFTTP)(char *transr, char *uplo, int *n, npy_complex64 *arf, npy_complex64 *ap, int *info);
int F_FUNC(ctfttr,CTFTTR)(char *transr, char *uplo, int *n, npy_complex64 *arf, npy_complex64 *a, int *lda, int *info);
...
int F_FUNC(ctpmqrt,CTPMQRT)(char *side, char *trans, int *m, int *n, int *k, int *l, int *nb, npy_complex64 *v, int *ldv, npy_complex64 *t, int *ldt, npy_complex64 *a, int *lda, npy_complex64 *b, int *ldb, npy_complex64 *work, int *info);
int F_FUNC(ctpqrt,CTPQRT)(int *m, int *n, int *l, int *nb, npy_complex64 *a, int *lda, npy_complex64 *b, int *ldb, npy_complex64 *t, int *ldt, npy_complex64 *work, int *info);
int F_FUNC(ctpqrt2,CTPQRT2)(int *m, int *n, int *l, npy_complex64 *a, int *lda, npy_complex64 *b, int *ldb, npy_complex64 *t, int *ldt, int *info);
int F_FUNC(ctprfb,CTPRFB)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, npy_complex64 *v, int *ldv, npy_complex64 *t, int *ldt, npy_complex64 *a, int *lda, npy_complex64 *b, int *ldb, npy_complex64 *work, int *ldwork);
...
int F_FUNC(ctpttf,CTPTTF)(char *transr, char *uplo, int *n, npy_complex64 *ap, npy_complex64 *arf, int *info);
int F_FUNC(ctpttr,CTPTTR)(char *uplo, int *n, npy_complex64 *ap, npy_complex64 *a, int *lda, int *info);
...
int F_FUNC(ctrttf,CTRTTF)(char *transr, char *uplo, int *n, npy_complex64 *a, int *lda, npy_complex64 *arf, int *info);
int F_FUNC(ctrttp,CTRTTP)(char *uplo, int *n, npy_complex64 *a, int *lda, npy_complex64 *ap, int *info);
int F_FUNC(ctzrzf,CTZRZF)(int *m, int *n, npy_complex64 *a, int *lda, npy_complex64 *tau, npy_complex64 *work, int *lwork, int *info);
int F_FUNC(cunbdb,CUNBDB)(char *trans, char *signs, int *m, int *p, int *q, npy_complex64 *x11, int *ldx11, npy_complex64 *x12, int *ldx12, npy_complex64 *x21, int *ldx21, npy_complex64 *x22, int *ldx22, float *theta, float *phi, npy_complex64 *taup1, npy_complex64 *taup2, npy_complex64 *tauq1, npy_complex64 *tauq2, npy_complex64 *work, int *lwork, int *info);
...
int F_FUNC(dgbequb,DGBEQUB)(int *m, int *n, int *kl, int *ku, double *ab, int *ldab, double *r, double *c, double *rowcnd, double *colcnd, double *amax, int *info);
...
int F_FUNC(dgeequb,DGEEQUB)(int *m, int *n, double *a, int *lda, double *r, double *c, double *rowcnd, double *colcnd, double *amax, int *info);
...
int F_FUNC(dgejsv,DGEJSV)(char *joba, char *jobu, char *jobv, char *jobr, char *jobt, char *jobp, int *m, int *n, double *a, int *lda, double *sva, double *u, int *ldu, double *v, int *ldv, double *work, int *lwork, int *iwork, int *info);
...
int F_FUNC(dgemqrt,DGEMQRT)(char *side, char *trans, int *m, int *n, int *k, int *nb, double *v, int *ldv, double *t, int *ldt, double *c, int *ldc, double *work, int *info);
...
int F_FUNC(dgeqr2p,DGEQR2P)(int *m, int *n, double *a, int *lda, double *tau, double *work, int *info);
int F_FUNC(dgeqrf,DGEQRF)(int *m, int *n, double *a, int *lda, double *tau, double *work, int *lwork, int *info);
int F_FUNC(dgeqrfp,DGEQRFP)(int *m, int *n, double *a, int *lda, double *tau, double *work, int *lwork, int *info);
int F_FUNC(dgeqrt,DGEQRT)(int *m, int *n, int *nb, double *a, int *lda, double *t, int *ldt, double *work, int *info);
int F_FUNC(dgeqrt2,DGEQRT2)(int *m, int *n, double *a, int *lda, double *t, int *ldt, int *info);
int F_FUNC(dgeqrt3,DGEQRT3)(int *m, int *n, double *a, int *lda, double *t, int *ldt, int *info);
...
int F_FUNC(dgesvj,DGESVJ)(char *joba, char *jobu, char *jobv, int *m, int *n, double *a, int *lda, double *sva, int *mv, double *v, int *ldv, double *work, int *lwork, int *info);
...
int F_FUNC(dgsvj0,DGSVJ0)(char *jobv, int *m, int *n, double *a, int *lda, double *d, double *sva, int *mv, double *v, int *ldv, double *eps, double *sfmin, double *tol, int *nsweep, double *work, int *lwork, int *info);
int F_FUNC(dgsvj1,DGSVJ1)(char *jobv, int *m, int *n, int *n1, double *a, int *lda, double *d, double *sva, int *mv, double *v, int *ldv, double *eps, double *sfmin, double *tol, int *nsweep, double *work, int *lwork, int *info);
...
int F_FUNC(dlapmr,DLAPMR)(int *forwrd, int *m, int *n, double *x, int *ldx, int *k);
...
int F_FUNC(dlarfgp,DLARFGP)(int *n, double *alpha, double *x, int *incx, double *tau);
...
int F_FUNC(dlartgp,DLARTGP)(double *f, double *g, double *cs, double *sn, double *r);
int F_FUNC(dlartgs,DLARTGS)(double *x, double *y, double *sigma, double *cs, double *sn);
...
int F_FUNC(dlasq3,DLASQ3)(int *i0, int *n0, double *z, int *pp, double *dmin, double *sigma, double *desig, double *qmax, int *nfail, int *iter, int *ndiv, int *ieee, int *ttype, double *dmin1, double *dmin2, double *dn, double *dn1, double *dn2, double *g, double *tau);
int F_FUNC(dlasq4,DLASQ4)(int *i0, int *n0, double *z, int *pp, int *n0in, double *dmin, double *dmin1, double *dmin2, double *dn, double *dn1, double *dn2, double *tau, int *ttype, double *g);
...
int F_FUNC(dlat2s,DLAT2S)(char *uplo, int *n, double *a, int *lda, float *sa, int *ldsa, int *info);
...
int F_FUNC(dorbdb,DORBDB)(char *trans, char *signs, int *m, int *p, int *q, double *x11, int *ldx11, double *x12, int *ldx12, double *x21, int *ldx21, double *x22, int *ldx22, double *theta, double *phi, double *taup1, double *taup2, double *tauq1, double *tauq2, double *work, int *lwork, int *info);
int F_FUNC(dorcsd,DORCSD)(char *jobu1, char *jobu2, char *jobv1t, char *jobv2t, char *trans, char *signs, int *m, int *p, int *q, double *x11, int *ldx11, double *x12, int *ldx12, double *x21, int *ldx21, double *x22, int *ldx22, double *theta, double *u1, int *ldu1, double *u2, int *ldu2, double *v1t, int *ldv1t, double *v2t, int *ldv2t, double *work, int *lwork, int *iwork, int *info);
...
int F_FUNC(dpftrf,DPFTRF)(char *transr, char *uplo, int *n, double *a, int *info);
int F_FUNC(dpftri,DPFTRI)(char *transr, char *uplo, int *n, double *a, int *info);
int F_FUNC(dpftrs,DPFTRS)(char *transr, char *uplo, int *n, int *nrhs, double *a, double *b, int *ldb, int *info);
...
int F_FUNC(dpoequb,DPOEQUB)(int *n, double *a, int *lda, double *s, double *scond, double *amax, int *info);
...
int F_FUNC(dpstf2,DPSTF2)(char *uplo, int *n, double *a, int *lda, int *piv, int *rank, double *tol, double *work, int *info);
int F_FUNC(dpstrf,DPSTRF)(char *uplo, int *n, double *a, int *lda, int *piv, int *rank, double *tol, double *work, int *info);
...
int F_FUNC(dsfrk,DSFRK)(char *transr, char *uplo, char *trans, int *n, int *k, double *alpha, double *a, int *lda, double *beta, double *c);
...
int F_FUNC(dsposv,DSPOSV)(char *uplo, int *n, int *nrhs, double *a, int *lda, double *b, int *ldb, double *x, int *ldx, double *work, float *swork, int *iter, int *info);
...
int F_FUNC(dsyconv,DSYCONV)(char *uplo, char *way, int *n, double *a, int *lda, int *ipiv, double *work, int *info);
int F_FUNC(dsyequb,DSYEQUB)(char *uplo, int *n, double *a, int *lda, double *s, double *scond, double *amax, double *work, int *info);
...
int F_FUNC(dsyswapr,DSYSWAPR)(char *uplo, int *n, double *a, int *lda, int *i1, int *i2);
...
int F_FUNC(dsytri2,DSYTRI2)(char *uplo, int *n, double *a, int *lda, int *ipiv, double *work, int *lwork, int *info);
int F_FUNC(dsytri2x,DSYTRI2X)(char *uplo, int *n, double *a, int *lda, int *ipiv, double *work, int *nb, int *info);
int F_FUNC(dsytrs,DSYTRS)(char *uplo, int *n, int *nrhs, double *a, int *lda, int *ipiv, double *b, int *ldb, int *info);
int F_FUNC(dsytrs2,DSYTRS2)(char *uplo, int *n, int *nrhs, double *a, int *lda, int *ipiv, double *b, int *ldb, double *work, int *info);
...
int F_FUNC(dtfsm,DTFSM)(char *transr, char *side, char *uplo, char *trans, char *diag, int *m, int *n, double *alpha, double *a, double *b, int *ldb);
int F_FUNC(dtftri,DTFTRI)(char *transr, char *uplo, char *diag, int *n, double *a, int *info);
int F_FUNC(dtfttp,DTFTTP)(char *transr, char *uplo, int *n, double *arf, double *ap, int *info);
int F_FUNC(dtfttr,DTFTTR)(char *transr, char *uplo, int *n, double *arf, double *a, int *lda, int *info);
...
int F_FUNC(dtpmqrt,DTPMQRT)(char *side, char *trans, int *m, int *n, int *k, int *l, int *nb, double *v, int *ldv, double *t, int *ldt, double *a, int *lda, double *b, int *ldb, double *work, int *info);
int F_FUNC(dtpqrt,DTPQRT)(int *m, int *n, int *l, int *nb, double *a, int *lda, double *b, int *ldb, double *t, int *ldt, double *work, int *info);
int F_FUNC(dtpqrt2,DTPQRT2)(int *m, int *n, int *l, double *a, int *lda, double *b, int *ldb, double *t, int *ldt, int *info);
int F_FUNC(dtprfb,DTPRFB)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, double *v, int *ldv, double *t, int *ldt, double *a, int *lda, double *b, int *ldb, double *work, int *ldwork);
...
int F_FUNC(dtpttf,DTPTTF)(char *transr, char *uplo, int *n, double *ap, double *arf, int *info);
int F_FUNC(dtpttr,DTPTTR)(char *uplo, int *n, double *ap, double *a, int *lda, int *info);
...
int F_FUNC(dtrttf,DTRTTF)(char *transr, char *uplo, int *n, double *a, int *lda, double *arf, int *info);
int F_FUNC(dtrttp,DTRTTP)(char *uplo, int *n, double *a, int *lda, double *ap, int *info);
...
int F_FUNC(sbbcsd,SBBCSD)(char *jobu1, char *jobu2, char *jobv1t, char *jobv2t, char *trans, int *m, int *p, int *q, float *theta, float *phi, float *u1, int *ldu1, float *u2, int *ldu2, float *v1t, int *ldv1t, float *v2t, int *ldv2t, float *b11d, float *b11e, float *b12d, float *b12e, float *b21d, float *b21e, float *b22d, float *b22e, float *work, int *lwork, int *info);
...
int F_FUNC(sgbequb,SGBEQUB)(int *m, int *n, int *kl, int *ku, float *ab, int *ldab, float *r, float *c, float *rowcnd, float *colcnd, float *amax, int *info);
...
int F_FUNC(sgeequb,SGEEQUB)(int *m, int *n, float *a, int *lda, float *r, float *c, float *rowcnd, float *colcnd, float *amax, int *info);
...
int F_FUNC(sgejsv,SGEJSV)(char *joba, char *jobu, char *jobv, char *jobr, char *jobt, char *jobp, int *m, int *n, float *a, int *lda, float *sva, float *u, int *ldu, float *v, int *ldv, float *work, int *lwork, int *iwork, int *info);
...
int F_FUNC(sgemqrt,SGEMQRT)(char *side, char *trans, int *m, int *n, int *k, int *nb, float *v, int *ldv, float *t, int *ldt, float *c, int *ldc, float *work, int *info);
...
int F_FUNC(sgeqr2p,SGEQR2P)(int *m, int *n, float *a, int *lda, float *tau, float *work, int *info);
int F_FUNC(sgeqrf,SGEQRF)(int *m, int *n, float *a, int *lda, float *tau, float *work, int *lwork, int *info);
int F_FUNC(sgeqrfp,SGEQRFP)(int *m, int *n, float *a, int *lda, float *tau, float *work, int *lwork, int *info);
int F_FUNC(sgeqrt,SGEQRT)(int *m, int *n, int *nb, float *a, int *lda, float *t, int *ldt, float *work, int *info);
int F_FUNC(sgeqrt2,SGEQRT2)(int *m, int *n, float *a, int *lda, float *t, int *ldt, int *info);
int F_FUNC(sgeqrt3,SGEQRT3)(int *m, int *n, float *a, int *lda, float *t, int *ldt, int *info);
...
int F_FUNC(sgesvj,SGESVJ)(char *joba, char *jobu, char *jobv, int *m, int *n, float *a, int *lda, float *sva, int *mv, float *v, int *ldv, float *work, int *lwork, int *info);
...
int F_FUNC(sgsvj0,SGSVJ0)(char *jobv, int *m, int *n, float *a, int *lda, float *d, float *sva, int *mv, float *v, int *ldv, float *eps, float *sfmin, float *tol, int *nsweep, float *work, int *lwork, int *info);
int F_FUNC(sgsvj1,SGSVJ1)(char *jobv, int *m, int *n, int *n1, float *a, int *lda, float *d, float *sva, int *mv, float *v, int *ldv, float *eps, float *sfmin, float *tol, int *nsweep, float *work, int *lwork, int *info);
...
int F_FUNC(slapmr,SLAPMR)(int *forwrd, int *m, int *n, float *x, int *ldx, int *k);
...
int F_FUNC(slarfgp,SLARFGP)(int *n, float *alpha, float *x, int *incx, float *tau);
...
int F_FUNC(slartgp,SLARTGP)(float *f, float *g, float *cs, float *sn, float *r);
int F_FUNC(slartgs,SLARTGS)(float *x, float *y, float *sigma, float *cs, float *sn);
...
int F_FUNC(slasq3,SLASQ3)(int *i0, int *n0, float *z, int *pp, float *dmin, float *sigma, float *desig, float *qmax, int *nfail, int *iter, int *ndiv, int *ieee, int *ttype, float *dmin1, float *dmin2, float *dn, float *dn1, float *dn2, float *g, float *tau);
int F_FUNC(slasq4,SLASQ4)(int *i0, int *n0, float *z, int *pp, int *n0in, float *dmin, float *dmin1, float *dmin2, float *dn, float *dn1, float *dn2, float *tau, int *ttype, float *g);
...
int F_FUNC(sorbdb,SORBDB)(char *trans, char *signs, int *m, int *p, int *q, float *x11, int *ldx11, float *x12, int *ldx12, float *x21, int *ldx21, float *x22, int *ldx22, float *theta, float *phi, float *taup1, float *taup2, float *tauq1, float *tauq2, float *work, int *lwork, int *info);
int F_FUNC(sorcsd,SORCSD)(char *jobu1, char *jobu2, char *jobv1t, char *jobv2t, char *trans, char *signs, int *m, int *p, int *q, float *x11, int *ldx11, float *x12, int *ldx12, float *x21, int *ldx21, float *x22, int *ldx22, float *theta, float *u1, int *ldu1, float *u2, int *ldu2, float *v1t, int *ldv1t, float *v2t, int *ldv2t, float *work, int *lwork, int *iwork, int *info);
...
int F_FUNC(spftrf,SPFTRF)(char *transr, char *uplo, int *n, float *a, int *info);
int F_FUNC(spftri,SPFTRI)(char *transr, char *uplo, int *n, float *a, int *info);
int F_FUNC(spftrs,SPFTRS)(char *transr, char *uplo, int *n, int *nrhs, float *a, float *b, int *ldb, int *info);
...
int F_FUNC(spoequb,SPOEQUB)(int *n, float *a, int *lda, float *s, float *scond, float *amax, int *info);
...
int F_FUNC(spstf2,SPSTF2)(char *uplo, int *n, float *a, int *lda, int *piv, int *rank, float *tol, float *work, int *info);
int F_FUNC(spstrf,SPSTRF)(char *uplo, int *n, float *a, int *lda, int *piv, int *rank, float *tol, float *work, int *info);
...
int F_FUNC(ssfrk,SSFRK)(char *transr, char *uplo, char *trans, int *n, int *k, float *alpha, float *a, int *lda, float *beta, float *c);
...
int F_FUNC(ssyconv,SSYCONV)(char *uplo, char *way, int *n, float *a, int *lda, int *ipiv, float *work, int *info);
int F_FUNC(ssyequb,SSYEQUB)(char *uplo, int *n, float *a, int *lda, float *s, float *scond, float *amax, float *work, int *info);
...
int F_FUNC(ssyswapr,SSYSWAPR)(char *uplo, int *n, float *a, int *lda, int *i1, int *i2);
...
int F_FUNC(ssytri2,SSYTRI2)(char *uplo, int *n, float *a, int *lda, int *ipiv, float *work, int *lwork, int *info);
int F_FUNC(ssytri2x,SSYTRI2X)(char *uplo, int *n, float *a, int *lda, int *ipiv, float *work, int *nb, int *info);
int F_FUNC(ssytrs,SSYTRS)(char *uplo, int *n, int *nrhs, float *a, int *lda, int *ipiv, float *b, int *ldb, int *info);
int F_FUNC(ssytrs2,SSYTRS2)(char *uplo, int *n, int *nrhs, float *a, int *lda, int *ipiv, float *b, int *ldb, float *work, int *info);
...
int F_FUNC(stfsm,STFSM)(char *transr, char *side, char *uplo, char *trans, char *diag, int *m, int *n, float *alpha, float *a, float *b, int *ldb);
int F_FUNC(stftri,STFTRI)(char *transr, char *uplo, char *diag, int *n, float *a, int *info);
int F_FUNC(stfttp,STFTTP)(char *transr, char *uplo, int *n, float *arf, float *ap, int *info);
int F_FUNC(stfttr,STFTTR)(char *transr, char *uplo, int *n, float *arf, float *a, int *lda, int *info);
...
int F_FUNC(stpmqrt,STPMQRT)(char *side, char *trans, int *m, int *n, int *k, int *l, int *nb, float *v, int *ldv, float *t, int *ldt, float *a, int *lda, float *b, int *ldb, float *work, int *info);
int F_FUNC(stpqrt,STPQRT)(int *m, int *n, int *l, int *nb, float *a, int *lda, float *b, int *ldb, float *t, int *ldt, float *work, int *info);
int F_FUNC(stpqrt2,STPQRT2)(int *m, int *n, int *l, float *a, int *lda, float *b, int *ldb, float *t, int *ldt, int *info);
int F_FUNC(stprfb,STPRFB)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, float *v, int *ldv, float *t, int *ldt, float *a, int *lda, float *b, int *ldb, float *work, int *ldwork);
...
int F_FUNC(stpttf,STPTTF)(char *transr, char *uplo, int *n, float *ap, float *arf, int *info);
int F_FUNC(stpttr,STPTTR)(char *uplo, int *n, float *ap, float *a, int *lda, int *info);
...
int F_FUNC(strttf,STRTTF)(char *transr, char *uplo, int *n, float *a, int *lda, float *arf, int *info);
int F_FUNC(strttp,STRTTP)(char *uplo, int *n, float *a, int *lda, float *ap, int *info);
int F_FUNC(stzrzf,STZRZF)(int *m, int *n, float *a, int *lda, float *tau, float *work, int *lwork, int *info);
int F_FUNC(xerbla_array,XERBLA_ARRAY)(char *srname_array, int *srname_len, int *info);
int F_FUNC(zbbcsd,ZBBCSD)(char *jobu1, char *jobu2, char *jobv1t, char *jobv2t, char *trans, int *m, int *p, int *q, double *theta, double *phi, npy_complex128 *u1, int *ldu1, npy_complex128 *u2, int *ldu2, npy_complex128 *v1t, int *ldv1t, npy_complex128 *v2t, int *ldv2t, double *b11d, double *b11e, double *b12d, double *b12e, double *b21d, double *b21e, double *b22d, double *b22e, double *rwork, int *lrwork, int *info);
...
int F_FUNC(zcgesv,ZCGESV)(int *n, int *nrhs, npy_complex128 *a, int *lda, int *ipiv, npy_complex128 *b, int *ldb, npy_complex128 *x, int *ldx, npy_complex128 *work, npy_complex64 *swork, double *rwork, int *iter, int *info);
int F_FUNC(zcposv,ZCPOSV)(char *uplo, int *n, int *nrhs, npy_complex128 *a, int *lda, npy_complex128 *b, int *ldb, npy_complex128 *x, int *ldx, npy_complex128 *work, npy_complex64 *swork, double *rwork, int *iter, int *info);
...
int F_FUNC(zgbequb,ZGBEQUB)(int *m, int *n, int *kl, int *ku, npy_complex128 *ab, int *ldab, double *r, double *c, double *rowcnd, double *colcnd, double *amax, int *info);
...
int F_FUNC(zgeequb,ZGEEQUB)(int *m, int *n, npy_complex128 *a, int *lda, double *r, double *c, double *rowcnd, double *colcnd, double *amax, int *info);
...
int F_FUNC(zgemqrt,ZGEMQRT)(char *side, char *trans, int *m, int *n, int *k, int *nb, npy_complex128 *v, int *ldv, npy_complex128 *t, int *ldt, npy_complex128 *c, int *ldc, npy_complex128 *work, int *info);
...
int F_FUNC(zgeqr2p,ZGEQR2P)(int *m, int *n, npy_complex128 *a, int *lda, npy_complex128 *tau, npy_complex128 *work, int *info);
int F_FUNC(zgeqrf,ZGEQRF)(int *m, int *n, npy_complex128 *a, int *lda, npy_complex128 *tau, npy_complex128 *work, int *lwork, int *info);
int F_FUNC(zgeqrfp,ZGEQRFP)(int *m, int *n, npy_complex128 *a, int *lda, npy_complex128 *tau, npy_complex128 *work, int *lwork, int *info);
int F_FUNC(zgeqrt,ZGEQRT)(int *m, int *n, int *nb, npy_complex128 *a, int *lda, npy_complex128 *t, int *ldt, npy_complex128 *work, int *info);
int F_FUNC(zgeqrt2,ZGEQRT2)(int *m, int *n, npy_complex128 *a, int *lda, npy_complex128 *t, int *ldt, int *info);
int F_FUNC(zgeqrt3,ZGEQRT3)(int *m, int *n, npy_complex128 *a, int *lda, npy_complex128 *t, int *ldt, int *info);
...
int F_FUNC(zheequb,ZHEEQUB)(char *uplo, int *n, npy_complex128 *a, int *lda, double *s, double *scond, double *amax, npy_complex128 *work, int *info);
...
int F_FUNC(zheswapr,ZHESWAPR)(char *uplo, int *n, npy_complex128 *a, int *lda, int *i1, int *i2);
...
int F_FUNC(zhetri2,ZHETRI2)(char *uplo, int *n, npy_complex128 *a, int *lda, int *ipiv, npy_complex128 *work, int *lwork, int *info);
int F_FUNC(zhetri2x,ZHETRI2X)(char *uplo, int *n, npy_complex128 *a, int *lda, int *ipiv, npy_complex128 *work, int *nb, int *info);
int F_FUNC(zhetrs,ZHETRS)(char *uplo, int *n, int *nrhs, npy_complex128 *a, int *lda, int *ipiv, npy_complex128 *b, int *ldb, int *info);
int F_FUNC(zhetrs2,ZHETRS2)(char *uplo, int *n, int *nrhs, npy_complex128 *a, int *lda, int *ipiv, npy_complex128 *b, int *ldb, npy_complex128 *work, int *info);
int F_FUNC(zhfrk,ZHFRK)(char *transr, char *uplo, char *trans, int *n, int *k, double *alpha, npy_complex128 *a, int *lda, double *beta, npy_complex128 *c);
...
int F_FUNC(zlapmr,ZLAPMR)(int *forwrd, int *m, int *n, npy_complex128 *x, int *ldx, int *k);
...
int F_FUNC(zlarfgp,ZLARFGP)(int *n, npy_complex128 *alpha, npy_complex128 *x, int *incx, npy_complex128 *tau);
...
int F_FUNC(zlat2c,ZLAT2C)(char *uplo, int *n, npy_complex128 *a, int *lda, npy_complex64 *sa, int *ldsa, int *info);
...
int F_FUNC(zpftrf,ZPFTRF)(char *transr, char *uplo, int *n, npy_complex128 *a, int *info);
int F_FUNC(zpftri,ZPFTRI)(char *transr, char *uplo, int *n, npy_complex128 *a, int *info);
int F_FUNC(zpftrs,ZPFTRS)(char *transr, char *uplo, int *n, int *nrhs, npy_complex128 *a, npy_complex128 *b, int *ldb, int *info);
...
int F_FUNC(zpoequb,ZPOEQUB)(int *n, npy_complex128 *a, int *lda, double *s, double *scond, double *amax, int *info);
...
int F_FUNC(zpstf2,ZPSTF2)(char *uplo, int *n, npy_complex128 *a, int *lda, int *piv, int *rank, double *tol, double *work, int *info);
int F_FUNC(zpstrf,ZPSTRF)(char *uplo, int *n, npy_complex128 *a, int *lda, int *piv, int *rank, double *tol, double *work, int *info);
...
int F_FUNC(zsyconv,ZSYCONV)(char *uplo, char *way, int *n, npy_complex128 *a, int *lda, int *ipiv, npy_complex128 *work, int *info);
int F_FUNC(zsyequb,ZSYEQUB)(char *uplo, int *n, npy_complex128 *a, int *lda, double *s, double *scond, double *amax, npy_complex128 *work, int *info);
...
int F_FUNC(zsyswapr,ZSYSWAPR)(char *uplo, int *n, npy_complex128 *a, int *lda, int *i1, int *i2);
...
int F_FUNC(zsytri2,ZSYTRI2)(char *uplo, int *n, npy_complex128 *a, int *lda, int *ipiv, npy_complex128 *work, int *lwork, int *info);
int F_FUNC(zsytri2x,ZSYTRI2X)(char *uplo, int *n, npy_complex128 *a, int *lda, int *ipiv, npy_complex128 *work, int *nb, int *info);
int F_FUNC(zsytrs,ZSYTRS)(char *uplo, int *n, int *nrhs, npy_complex128 *a, int *lda, int *ipiv, npy_complex128 *b, int *ldb, int *info);
int F_FUNC(zsytrs2,ZSYTRS2)(char *uplo, int *n, int *nrhs, npy_complex128 *a, int *lda, int *ipiv, npy_complex128 *b, int *ldb, npy_complex128 *work, int *info);
...
int F_FUNC(ztfsm,ZTFSM)(char *transr, char *side, char *uplo, char *trans, char *diag, int *m, int *n, npy_complex128 *alpha, npy_complex128 *a, npy_complex128 *b, int *ldb);
int F_FUNC(ztftri,ZTFTRI)(char *transr, char *uplo, char *diag, int *n, npy_complex128 *a, int *info);
int F_FUNC(ztfttp,ZTFTTP)(char *transr, char *uplo, int *n, npy_complex128 *arf, npy_complex128 *ap, int *info);
int F_FUNC(ztfttr,ZTFTTR)(char *transr, char *uplo, int *n, npy_complex128 *arf, npy_complex128 *a, int *lda, int *info);
...
int F_FUNC(ztpmqrt,ZTPMQRT)(char *side, char *trans, int *m, int *n, int *k, int *l, int *nb, npy_complex128 *v, int *ldv, npy_complex128 *t, int *ldt, npy_complex128 *a, int *lda, npy_complex128 *b, int *ldb, npy_complex128 *work, int *info);
int F_FUNC(ztpqrt,ZTPQRT)(int *m, int *n, int *l, int *nb, npy_complex128 *a, int *lda, npy_complex128 *b, int *ldb, npy_complex128 *t, int *ldt, npy_complex128 *work, int *info);
int F_FUNC(ztpqrt2,ZTPQRT2)(int *m, int *n, int *l, npy_complex128 *a, int *lda, npy_complex128 *b, int *ldb, npy_complex128 *t, int *ldt, int *info);
int F_FUNC(ztprfb,ZTPRFB)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, npy_complex128 *v, int *ldv, npy_complex128 *t, int *ldt, npy_complex128 *a, int *lda, npy_complex128 *b, int *ldb, npy_complex128 *work, int *ldwork);
...
int F_FUNC(ztpttf,ZTPTTF)(char *transr, char *uplo, int *n, npy_complex128 *ap, npy_complex128 *arf, int *info);
int F_FUNC(ztpttr,ZTPTTR)(char *uplo, int *n, npy_complex128 *ap, npy_complex128 *a, int *lda, int *info);
...
int F_FUNC(ztrttf,ZTRTTF)(char *transr, char *uplo, int *n, npy_complex128 *a, int *lda, npy_complex128 *arf, int *info);
int F_FUNC(ztrttp,ZTRTTP)(char *uplo, int *n, npy_complex128 *a, int *lda, npy_complex128 *ap, int *info);
int F_FUNC(ztzrzf,ZTZRZF)(int *m, int *n, npy_complex128 *a, int *lda, npy_complex128 *tau, npy_complex128 *work, int *lwork, int *info);
int F_FUNC(zunbdb,ZUNBDB)(char *trans, char *signs, int *m, int *p, int *q, npy_complex128 *x11, int *ldx11, npy_complex128 *x12, int *ldx12, npy_complex128 *x21, int *ldx21, npy_complex128 *x22, int *ldx22, double *theta, double *phi, npy_complex128 *taup1, npy_complex128 *taup2, npy_complex128 *tauq1, npy_complex128 *tauq2, npy_complex128 *work, int *lwork, int *info);
int F_FUNC(zuncsd,ZUNCSD)(char *jobu1, char *jobu2, char *jobv1t, char *jobv2t, char *trans, char *signs, int *m, int *p, int *q, npy_complex128 *x11, int *ldx11, npy_complex128 *x12, int *ldx12, npy_complex128 *x21, int *ldx21, npy_complex128 *x22, int *ldx22, double *theta, npy_complex128 *u1, int *ldu1, npy_complex128 *u2, int *ldu2, npy_complex128 *v1t, int *ldv1t, npy_complex128 *v2t, int *ldv2t, npy_complex128 *work, int *lwork, double *rwork, int *lrwork, int *iwork, int *info);
...
int F_FUNC(ilaenv,ILAENV)(int *ispec, char *name, char *opts, int *n1, int *n2, int *n3, int *n4);
