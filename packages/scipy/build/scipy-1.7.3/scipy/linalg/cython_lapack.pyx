...
cdef extern from "_lapack_subroutines.h":
    void _fortran_ilaenv "F_FUNC(ilaenv,ILAENV)"(int *ispec, char *name, char *opts, int *n1, int *n2, int *n3, int *n4) nogil
cdef void ilaenv(int *ispec, char *name, char *opts, int *n1, int *n2, int *n3, int *n4) nogil:
    _fortran_ilaenv(ispec, name, opts, n1, n2, n3, n4)
