...
static int (*__pyx_f_5scipy_6linalg_11cython_blas_drot)(int *, __pyx_t_5scipy_6linalg_11cython_blas_d *, int *, __pyx_t_5scipy_6linalg_11cython_blas_d *, int *, __pyx_t_5scipy_6linalg_11cython_blas_d *, __pyx_t_5scipy_6linalg_11cython_blas_d *); /*proto*/
 ...
 */
          ...
          (void)(__pyx_f_5scipy_6linalg_11cython_blas_drot((&__pyx_v_k), (&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_S.data + __pyx_t_9 * __pyx_v_S.strides[0]) )) + __pyx_t_12)) )))), (&__pyx_v_one), (&(*((double *) ( /* dim=0 */ (__pyx_v_diag_row.data + __pyx_t_15 * __pyx_v_diag_row.strides[0]) )))), (&__pyx_v_one), (&__pyx_v_cs), (&__pyx_v_sn)));
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "drot", (void (**)(void))&__pyx_f_5scipy_6linalg_11cython_blas_drot, "int (int *, __pyx_t_5scipy_6linalg_11cython_blas_d *, int *, __pyx_t_5scipy_6linalg_11cython_blas_d *, int *, __pyx_t_5scipy_6linalg_11cython_blas_d *, __pyx_t_5scipy_6linalg_11cython_blas_d *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
