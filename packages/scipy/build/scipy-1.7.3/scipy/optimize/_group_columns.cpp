...
namespace __pythran__group_columns
{
  ...
  typename group_sparse::type<argument_type0, argument_type1, argument_type2, argument_type3>::result_type group_sparse::operator()(argument_type0&& m, argument_type1&& n, argument_type2&& indices, argument_type3&& indptr) const
  {
    ...
    {
      long  __target139877265928976 = n;
      for (long  i=0L; i < __target139877265928976; i += 1L)
      {
        ...
        {
          long  __target139877265937120 = indptr.fast(pythonic::operator_::add(i, 1L));
          for (long  k=indptr.fast(i); k < __target139877265937120; k += 1L)
          {
            union_[indices[k]] = 1L;
          }
        }
        {
          long  __target139877265937600 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, groups));
          for (long  j=0L; j < __target139877265937600; j += 1L)
          {
            ...
            {
              long  __target139877265789568 = indptr.fast(pythonic::operator_::add(j, 1L));
              for (long  k_=indptr.fast(j); k_ < __target139877265789568; k_ += 1L)
              {
            ...
            {
              {
                long  __target139877265802576 = indptr.fast(pythonic::operator_::add(j, 1L));
                for (long  k__=indptr.fast(j); k__ < __target139877265802576; k__ += 1L)
                {
  ...
  typename group_dense::type<argument_type0, argument_type1, argument_type2>::result_type group_dense::operator()(argument_type0&& m, argument_type1&& n, argument_type2&& A) const
  {
    ...
    {
      long  __target139877268977600 = n;
      for (long  i=0L; i < __target139877268977600; i += 1L)
      {
        if (pythonic::operator_::ge(groups.fast(i), 0L))
        {
          continue;
        ...
        {
          long  __target139877268895824 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, groups));
          for (long  j=0L; j < __target139877268895824; j += 1L)
          {
            if (pythonic::operator_::lt(groups.fast(j), 0L))
            {
              all_grouped = pythonic::builtins::False;
            ...
            typename pythonic::lazy<decltype(pythonic::builtins::False)>::type intersect = pythonic::builtins::False;
            {
              long  __target139877269002032 = m;
              for (long  k=0L; k < __target139877269002032; k += 1L)
              {
