...
extern int F_FUNC(hygfz,HYGFZ)(double*,double*,double*,npy_cdouble*,npy_cdouble*,int*);
extern int F_FUNC(cchg,CCHG)(double*,double*,npy_cdouble*,npy_cdouble*);
extern int F_FUNC(chgm,CHGM)(double*,double*,double*,double*);
extern int F_FUNC(chgu,CHGU)(double*,double*,double*,double*,int*,int*);
...
extern int F_FUNC(eixz,EIXZ)(npy_cdouble*,npy_cdouble*);
