...
static doublecomplex c_b771 = {-.125,0.};
static doublecomplex c_b775 = {.375,0.};
static integer c__1 = 1;
static doublecomplex c_b1161 = {-2.,0.};
static doublereal c_b1168 = .33333;
static doublecomplex c_b1386 = {-1.,0.};
...
/*          Abr & Stg (9.5.14) */
	d__1 = (doublereal) (*n);
	d__2 = (doublereal) (*n);
	x = *n + pow_dd(&d__1, &c_b1168) * 1.85576f + 1.03315f / pow_dd(&d__2,
		 &c_b1168);
    }
    l = 0;
/*       2) iterate */
...
/*       -- Newton method for j_{N,L}' */
	...
	d__1 = (doublereal) (*n);
	d__2 = (doublereal) (*n);
	x = *n + pow_dd(&d__1, &c_b1168) * .80861f + .07249f / pow_dd(&d__2, &
		c_b1168);
    }
    if (*n == 0) {
	x = 3.8317f;
...
/*       -- Newton method for y_{N,L} */
	...
	d__1 = (doublereal) (*n);
	d__2 = (doublereal) (*n);
	x = *n + pow_dd(&d__1, &c_b1168) * .93158f + .26035f / pow_dd(&d__2, &
		c_b1168);
    }
    l = 0;
    xguess = x;
...
/*       -- Newton method for y_{N,L}' */
	...
	d__1 = (doublereal) (*n);
	d__2 = (doublereal) (*n);
	x = *n + pow_dd(&d__1, &c_b1168) * 1.8211f + .94001f / pow_dd(&d__2, &
		c_b1168);
    }
    l = 0;
    xguess = x;
