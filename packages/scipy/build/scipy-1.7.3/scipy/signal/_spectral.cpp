...
namespace __pythran__spectral
{
  ...
  typename _lombscargle::type<argument_type0, argument_type1, argument_type2>::result_type _lombscargle::operator()(argument_type0&& x, argument_type1&& y, argument_type2&& freqs) const
  {
    ...
    {
      long  __target139877269264752 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, freqs));
      for (long  i=0L; i < __target139877269264752; i += 1L)
      {
        ...
        {
          long  __target139877268715024 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, x));
          for (long  j=0L; j < __target139877268715024; j += 1L)
          {
